  ...
  const modalContent = (
    <div className="pd-overlay" onClick={onClose}>
      <div className="pd-modal" onClick={stop} role="dialog" aria-modal="true">
        <button className="pd-close" onClick={onClose} aria-label="Cerrar detalle">
          ×
        </button>
        ...
        <div className="pd-content">
          <div className="pd-image">
            {product.imagen || (product.imagenes && product.imagenes[0]) ? (
              <img src={product.imagen || product.imagenes[0]} alt={product.nombre} />
            ) : (
          ...
          <div className="pd-info">
            ...
            <div className="pd-footer">
              ...
              <button className="pd-add" onClick={handleAdd} aria-label={`Añadir ${product.nombre} al carrito`}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6 6h15l-1.5 9h-11z" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                  <circle cx="10" cy="20" r="1" stroke="currentColor" strokeWidth="1.2" />
                  <circle cx="18" cy="20" r="1" stroke="currentColor" strokeWidth="1.2" />
                </svg>
                Añadir al carrito
              </button>
            </div>
