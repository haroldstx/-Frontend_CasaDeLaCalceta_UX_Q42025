...
const ProductCard = ({ product }) => {
  ...
  const handleAddToCart = async (e) => {
    ...
    try {
      addToCart({
        ...
        imagen: product.imagenes || product.ProductoImagenes?.[0]?.ruta,
        quantity: 1,
      });
  ...
  // Modificación en ProductCard.jsx
  // const imageUrl = product.imagenes
  //    `${API_URL}/products/${product.imagenes}`
  //   : product.imagenes?.length > 0
  //   `${API_URL}/products/${product.imagenes[0].imagen}`
